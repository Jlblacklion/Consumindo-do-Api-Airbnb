...
fetch(API_URL)
  ...
  .then(result => {
    ...
    data.map(element => {
      ...
      tituloCard.className = "property-type";
      tituloCard.innerHTML = property_type;
      ...
      preco.innerHTML = `Valor Total: ${price.toLocaleString("pt-br", {minimumFractionDigits:2})}`;
      ...
      cardText.appendChild(tituloCard);
